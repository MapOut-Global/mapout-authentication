...
} = require("../mapout-controllers/otp_login/utils/auth.utils");
const {
  completeHRgigRegistration,
} = require("../hrgig-controllers/utils/auth.utils");
...
module.exports = {
  googleAuth: async (req, res) => {
    try {
      const { token, deviceToken, organisationName } = req.body;
      let client;
      let ticket;
      let userInfo;
