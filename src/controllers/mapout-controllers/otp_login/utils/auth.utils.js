                ...
                $add: [
                  {
                    $cond: [
                      {
                        $ne: [
                          { $ifNull: ["$$workDetail.field_of_work", null] },
                          null,
                        ],
                      },
                      1,
                  ...
                  },
                  {
                    $cond: [
                      {
                        $ne: [
                          { $ifNull: ["$$workDetail.industry", null] },
                          null,
                        ],
                      },
                      1,
                  ...
                  {
                    $cond: [
                      { $ne: [{ $ifNull: ["$$workDetail.role", null] }, null] },
                      1,
                      0,
                    ],
                  },
                ...
                $add: [
                  {
                    $cond: [
                      {
                        $ne: [{ $ifNull: ["$$eduDetail.college", null] }, null],
                      },
                      1,
                      0,
                    ],
                  },
                  {
                    $cond: [
                      {
                        $ne: [{ $ifNull: ["$$eduDetail.degree", null] }, null],
                      },
                      1,
                      0,
                    ],
                  },
                  {
                    $cond: [
                      {
                        $ne: [
                          { $ifNull: ["$$eduDetail.end_year", null] },
                          null,
                        ],
                      },
                      1,
                  ...
                  },
                  {
                    $cond: [
                      {
                        $ne: [
                          { $ifNull: ["$$eduDetail.specialization", null] },
                          null,
                        ],
                      },
                      1,
                  ...
                  },
                  {
                    $cond: [
                      {
                        $ne: [
                          { $ifNull: ["$$eduDetail.current_year", null] },
                          null,
                        ],
                      },
                      1,
              ...
              in: {
                $add: [
                  ...
                  },
                  {
                    $cond: [
                      {
                        $ne: [{ $ifNull: ["$$skill.soft_skills", null] }, null],
                      },
                      1,
                      0,
                    ],
        ...
        $divide: [
          {
            $add: [
              ...
              {
                $cond: [
                  { $ne: [{ $ifNull: ["$current_location", null] }, null] },
                  1,
                  0,
                ],
              },
    ...
    },
    {
      $project: {
        ...
        personalDetailsPercentage: {
          $round: [personalDetailsPercentageCalculation, 0],
        },
        workDetailsPercentage: {
          $round: [workDetailsPercentageCalculation, 0],
        },
        educationDetailsPercentage: {
          $round: [educationPercentageCalculation, 0],
        },
        skillAspirationsPercentage: {
          $round: [skillsAspirationsPercentageCalculation, 0],
        },
      },
    },
  ]);
